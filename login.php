...
<main class="container-fluid d-flex justify-content-center align-items-center min-vh-100">
    <div class="row w-100">
        <div class="col-md-6 p-4">
            <form action="acciones/usuarioLogin.php" method="POST" class="p-4">
        ...
        <div class="col-md-6 p-0">
            <img src="images/2.jpg" alt="Imagen" class="img-fluid" style="object-fit: cover; width: 100%; height: 100vh;">
        </div>
    </div>
</main>
